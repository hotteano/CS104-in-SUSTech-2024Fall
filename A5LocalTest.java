...
public class A5LocalTest {
    ...
    {
        GameSystem gameSystem = new GameSystem(players2, lands2);
        assertFalse(gameSystem.isGameOver());
        gameSystem.nextTurn(5, 23);
        gameSystem.nextTurn(2, 80);
        gameSystem.nextTurn(4, 80);
        gameSystem.nextTurn(3, 101);
        assertEquals("Player 1: at 5, has 77.0", gameSystem.currentPlayersState()[0]);
        assertEquals("Player 2: at 2, has 20.0", gameSystem.currentPlayersState()[1]);
        assertEquals("Player 3: at 4, has 20.0", gameSystem.currentPlayersState()[2]);
        assertEquals("Player 4: at 3, has 100.0", gameSystem.currentPlayersState()[3]);
        gameSystem.nextTurn(0, 10);
        gameSystem.nextTurn(3, 0);
        gameSystem.nextTurn(1, 0);
        gameSystem.nextTurn(2, 0);
        assertEquals("Player 1: at 5, has 111.5", gameSystem.currentPlayersState()[0]);
        assertEquals("Player 2: at 5, has 8.5", gameSystem.currentPlayersState()[1]);
        assertEquals("Player 3: at 5, has 8.5", gameSystem.currentPlayersState()[2]);
        assertEquals("Player 4: at 5, has 88.5", gameSystem.currentPlayersState()[3]);
        assertFalse(gameSystem.isGameOver());
    }
}